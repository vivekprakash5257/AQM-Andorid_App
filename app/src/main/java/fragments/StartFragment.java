...
import com.v.fina.detailspilani;
...
public class StartFragment extends Fragment {
    ...
    Modules.sensdata sensdata1=new sensdata();
   ...
   /* Result result3=new Result();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //AuthP();
        //Intent intent=new Intent(replaceFragment(BlankFragment);)
       // AuthBOSCH ();
        cancelAllRequests("main");
        //Pilani();
        //Delhi();
...
Cancel all the requests matching with the given tag
   ...
   /* public void AuthP (){
    ...
    public void aqip(){
        ...
        final String auth=loginbosch.getAuthToken();
        final String orgkey=loginbosch.getOrgKey();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0;i<jsonArray.length();i++){
                        ...
                        gpspilani=getActivity().findViewById(R.id.pilani_gpsTextView);
                        gpspilani.setText(gps1);
                        String aqip=aqiResult.getAqi().toString();
                        pilaniaqi=getActivity().findViewById(R.id.pilani_air_qualityTextView);

                        Double aq= aqiResult.getAqi();
                        if(aq >= 0&& aq <=50){
                            pilaniaqi.setBackgroundColor(0xFFACAF50);}
                            ...
                            pilaniaqi.setBackgroundColor(0xFFF44336);
                        }
                        else{
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    //for (int i=0;i<jsonArray.length();i++) {
                        ...
                        sensdata.setTemperature(res.getString("value"));
                        pilaniatemp = getActivity().findViewById(R.id.pilani_temp);
                        pilaniatemp.setText("TEMP: "+sensdata.getTemperature());
                        JSONObject result1 = jsonArray.getJSONObject(1);
                        sensdata.setHumidity(result1.getString("value"));
                        pilanihum = getActivity().findViewById(R.id.pilani_hum);
                        pilanihum.setText("HUM: "+sensdata.getHumidity());
                        JSONObject result2 = jsonArray.getJSONObject(2);
                        sensdata.setPm2p5(result2.getString("value"));
                        pilanipm2p5 = getActivity().findViewById(R.id.pilani_pm25);
                        pilanipm2p5.setText("PM2P5: "+sensdata.getPm2p5());
                        JSONObject result3 = jsonArray.getJSONObject(3);
                        sensdata.setPm10(result3.getString("value"));
                        pilanipm10 = getActivity().findViewById(R.id.pilani_pm10);
                        pilanipm10.setText("PM10: "+sensdata.getPm10());
                   // }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0;i<jsonArray.length();i++){
                        ...
                        aqiResult.setCityd(resultd.getString("city"));
                        aqiResult.setColord(resultd.getString("color"));
                        String gps1="GPS: "+aqiResult.getLatituded().toString()+"   "+aqiResult.getLongituded().toString();
                        gpsdelhi=getActivity().findViewById(R.id.delhi_gpsTextView);
                        gpsdelhi.setText(gps1);
                       /* String aqip=aqiResult.getAqi().toString();
...
*/
                        String aqidd=aqiResult.getAqid().toString();
                        delhiaqi=getActivity().findViewById(R.id.delhi_air_qualityTextView);
                    /*switch (aq){
                        case aq :if(aq >= 0&& aq <=50)
                            delhiaqi.setBackgroundColor(asdsad);
                            break;
                        ...
                        Double aqd= aqiResult.getAqid();
                        if(aqd >= 0&& aqd <=50){
                            delhiaqi.setBackgroundColor(0xFFACAF50);}
                        else if(aqd>=51 && aqd<=100) {
                            delhiaqi.setBackgroundColor(0xD88BC34A);
                        }
                        else if(aqd>=101 && aqd<=200){
                            ...
                            delhiaqi.setBackgroundColor(0xFFF44336);
                        }
                        else{
                            delhiaqi.setBackgroundColor(0xBCE91E63);
                        }
    ...
    public void SensorDelhi(){
        ...
        params1.put("avgDuration","1h");
        params1.put("propertiesList","SENS_TEMPERATURE,SENS_RELATIVE_HUMIDITY,SENS_PM2P5,SENS_PM10,SENS_NITROGEN_DIOXIDE,SENS_CARBON_MONOXIDE,SENS_SULPHUR_DIOXIDE,SENS_OZONE,SENS_SOUND");
        params1.put("thingKey",aqiResult.getThingKeyd());
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, Baseurl, new JSONObject(params1), new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    //for (int i=0;i<jsonArray.length();i++) {
                    JSONObject res = jsonArray.getJSONObject(0);
                    sensdata1.setTemperature(res.getString("value"));
                    //Toast.makeText(getActivity(),sensdata.getTemperature(),Toast.LENGTH_LONG).show();
                    ///JSONObject res1 = jsonArray.getJSONObject(3);
                    ////Toast.makeText(MainActivity.this,res1.getString("value")+"2",Toast.LENGTH_LONG).show();

                    sensdata1.setTemperature(res.getString("value"));
                    delhitemp = getActivity().findViewById(R.id.delhi_temp);
                    delhitemp.setText(new StringBuilder().append("TEMP: ").append(sensdata1.getTemperature()).toString());
                    JSONObject result1 = jsonArray.getJSONObject(1);
                    sensdata1.setHumidity(result1.getString("value"));
                    delhihum = getActivity().findViewById(R.id.delhi_hum);
                    delhihum.setText("HUM: "+sensdata1.getHumidity());
                    JSONObject result2 = jsonArray.getJSONObject(2);
                    sensdata1.setPm2p5(result2.getString("value"));
                    delhipm2p5 = getActivity().findViewById(R.id.delhi_pm25);
                    delhipm2p5.setText("PM2P5: "+sensdata1.getPm2p5());
                    JSONObject result3 = jsonArray.getJSONObject(3);
                    sensdata1.setPm10(result3.getString("value"));
                    delhipm10 = getActivity().findViewById(R.id.delhi_pm10);
                    delhipm10.setText("PM10: "+sensdata1.getPm10());
                    // }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
        ...
        ///Volley.newRequestQueue(getActivity()).add(request);
        addToRequestQueue(request,"delhi2");
    }
