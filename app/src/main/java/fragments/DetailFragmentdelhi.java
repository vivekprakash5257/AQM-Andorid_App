...
import Modules.SQLBASE;
import Modules.login;
import Modules.sensdata;


public class DetailFragmentdelhi extends Fragment implements View.OnClickListener{

    Modules.login login=new login();
    /*Result result3=new Result();
    *//*SEnsrResult result1=new SEnsrResult();
    SEnsrResult result2=new SEnsrResult();
    SEnsrResult result31=new SEnsrResult();
    SEnsrResult result4=new SEnsrResult();
    SEnsrResult result5=new SEnsrResult();
    SEnsrResult result6=new SEnsrResult();
    SEnsrResult result7=new SEnsrResult();
    SEnsrResult result8=new SEnsrResult();
    SEnsrResult result9=new SEnsrResult();
    SEnsrResult result10=new SEnsrResult();*/
    SQLBASE myDB;
...
Cancel all the requests matching with the given tag
    ...
    private void getDelhi() {
        Cursor cursor=myDBHelper.getdata("delhi");
...
/*public void AuthP (){
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    result1.setValue(jsonObject.getString("value"));
                    //k=value;
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String value=jsonObject.getString("value");
                    // result4.setValue(jsonObject.getString("value"));
                    result2.setValue(jsonObject.getString("value"));
                    //k=value;
                    //((TextView) context.findViewById(R.id.pilani_air_qualityTextView)).setText(value);
                    ...
                    // String t=thingkey+thingname;
                    //Toast.makeText(getActivity(),value,Toast.LENGTH_LONG).show();
                    String gps1=aqiResult.getLatituded().toString()+"  "+aqiResult.getLongituded().toString();
                    gps=getView().findViewById(R.id.latnlon);
                    gps.setText(gps1);
                    String thimgname=aqiResult.getThingNamed()+" "+aqiResult.getCityd();
                    thingname=getView().findViewById(R.id.thingnamectiy);
                    thingname.setText(thimgname);
                    String categor=aqiResult.getCategoryd();
                    category=getView().findViewById(R.id.cat);
                    category.setText(categor);
                    String poll=aqiResult.getPollutantd();
                    pol=getView().findViewById(R.id.pol);
                    pol.setText(poll);

                    String aqip=aqiResult.getAqid().toString();
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String value=jsonObject.getString("value");
                    // result4.setValue(jsonObject.getString("value"));
                    result31.setValue(jsonObject.getString("value"));
                    //k=value;
                    //((TextView) context.findViewById(R.id.pilani_air_qualityTextView)).setText(value);
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String value=jsonObject.getString("value");
                    // result4.setValue(jsonObject.getString("value"));
                    result5.setValue(jsonObject.getString("value"));
                    //k=value;
                    //((TextView) context.findViewById(R.id.pilani_air_qualityTextView)).setText(value);
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String value=jsonObject.getString("value");
                    // result4.setValue(jsonObject.getString("value"));
                    result6.setValue(jsonObject.getString("value"));
                    //k=value;
                    //((TextView) context.findViewById(R.id.pilani_air_qualityTextView)).setText(value);
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String value=jsonObject.getString("value");
                    // result4.setValue(jsonObject.getString("value"));
                    result7.setValue(jsonObject.getString("value"));
                    //k=value;
                    //((TextView) context.findViewById(R.id.pilani_air_qualityTextView)).setText(value);
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String value=jsonObject.getString("value");
                    // result4.setValue(jsonObject.getString("value"));
                    result8.setValue(jsonObject.getString("value"));
                    //k=value;
                    //((TextView) context.findViewById(R.id.pilani_air_qualityTextView)).setText(value);
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String value=jsonObject.getString("value");
                    // result4.setValue(jsonObject.getString("value"));
                    result9.setValue(jsonObject.getString("value"));
                    //k=value;
                    //((TextView) context.findViewById(R.id.pilani_air_qualityTextView)).setText(value);
        ...
        JsonObjectRequest jsonObjectRequest1= new JsonObjectRequest(Request.Method.GET, Baseurl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String value=jsonObject.getString("value");
                    // result4.setValue(jsonObject.getString("value"));
                    result10.setValue(jsonObject.getString("value"));
                    //k=value;
                    //((TextView) context.findViewById(R.id.pilani_air_qualityTextView)).setText(value);
    ...
    void dbset(){
        String loc= aqiResult.getLatituded().toString()+aqiResult.getLongituded().toString();
        myDB.insertData("pilani",loc,
                aqiResult.getAqid().toString(),aqiResult.getCategoryd(),aqiResult.getPollutantd(),result1.getValue(),result2.getValue(),result31.getValue(),
                result4.getValue(),result5.getValue(),result6.getValue(),result7.getValue(),result8.getValue(),result9.getValue(),result10.getValue());
